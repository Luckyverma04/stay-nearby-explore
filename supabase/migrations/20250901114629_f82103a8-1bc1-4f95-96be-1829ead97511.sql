...
BEGIN
  ...
  WHILE current_date < p_check_out LOOP
    ...
    SELECT COALESCE(ha.available_rooms, h.max_rooms, 100) INTO available_rooms
    FROM public.hotels h
    LEFT JOIN public.hotel_availability ha ON ha.hotel_id = h.id AND ha.date = current_date
...
BEGIN
  ...
  WHILE current_date < p_check_out LOOP
    ...
    WHERE ha.hotel_id = p_hotel_id AND ha.date = current_date;
